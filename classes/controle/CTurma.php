    ...
    class CTurma {
        ...
        public static function alterar($id) {
            ...
            if(empty($turma)) {
                ...
                $_SESSION['MSGBOX_MSG'] = "O ID informado para turma não existe!";
                ...
                $url = "../view/turmaAlterar.php?id=$tumra->id";
                $url .= "&nome=$turma->nome";
                $url .= "&ano=$turma->ano";
        ...
        public static function remover($id) {
            ...
            if(empty($turma)) {
                $_SESSION['MSGBOX_TITULO'] = "OPERAÇÃO INVÁLIDA!";
                $_SESSION['MSGBOX_MSG'] = "O ID informado para o turma não existe!";
                $_SESSION['MSGBOX_LINK'] = "turma.php";
                $_SESSION['MSGBOX_CLASSE'] = "alert alert-danger";
                // print_r($curso);
        ...
        public static function loadTabelaTurma() {
        ...
        public static function returnAllTurma(){
            return Turma::getTurma();
        }
        public static function montaTurma($id){
